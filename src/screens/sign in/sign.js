  ...
  return (
    <div className='flex flex-col w-screen h-screen justify-center items-center'>
        ...
        <div className='flex flex-col items-center w-[460px] h-[490px] border-[1px] rounded-md px-10 py-12 gap-3'>
            ...
            <p className='text-[#202124] text-[24px] font-[Google Sans]'>Sign in</p>

            <p className='text-[#202124] text-[16px] font-[Roboto]'>Use your Google Account</p>

            <div className='flex flex-col w-[100%] mt-4 gap-2'>
                <TextField className='w-[100%]' id='email-phone' label="Email or phone" variant="outlined"/>
                <Link className='text-[#1a73e8] text-[14px] font-[Roboto] font-[500]'>Forgot email?</Link>
            </div>

            <div className='flex flex-col w-[100%] mt-7'>
                <p className='text-[#5f6368] text-[14px] font-[Roboto]'>Not your computer? Use Guest mode to sign in privately.</p>
                <Link className='text-[#1a73e8] text-[14px] font-[Roboto] font-[500]'>Learn more</Link>
            </div>

            <div className='flex flex-row justify-between items-center w-[100%] h-[60px] mt-3 ml-[-16px]'>
                <Button 
                    className='' 
                    variant="text">
                        <Link  
